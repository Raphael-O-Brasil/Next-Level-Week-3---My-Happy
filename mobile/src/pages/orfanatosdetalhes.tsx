...
import mapMarkerImg from '../images/marker/marker.png';
import { RectButton} from 'react-native-gesture-handler';
import {useRoute} from '@react-navigation/native';
import api from '../services/api';
interface OrfanatosParamsDetails{
  id: number;
}
interface Orfanato{
  id: number;
...
export default function OrphanageDetails() {
  ...
  const params = route.params as OrfanatosParamsDetails;
  ...
  function HandlerMapRedirection(){
    ...
    <ScrollView style={styles.container}>
      ...
      <View style={styles.detailsContainer}>
        ...
        <View style={styles.mapContainer}>
          ...
          <TouchableOpacity onPress={HandlerMapRedirection} style={styles.routesContainer}>
        ...
        <Text style={styles.title}>Instruções para visita</Text>
            <Text style={styles.description}>{orfanato.instrucao}</Text>

        <View style={styles.scheduleContainer}>
          <View style={[styles.scheduleItem, styles.scheduleItemBlue]}>
            <Feather name="clock" size={40} color="#2AB5D1" />
            <Text style={[styles.scheduleText, styles.scheduleTextBlue]}>{orfanato.funcionamento}</Text>
          </View>
